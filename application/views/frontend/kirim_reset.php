    	...
    	<div >
    		<div class="container">
    			...
    			<div class=" con-w3l agileinf">
    				<form action="<?php echo base_url() ?>reset_pasword" method="post">
    					<div class="form-group">
    						<label class="form-label">Email</label>
    						<input type="email" class="form-control" name="password" placeholder="masukan email yang terdaftar...">
    					</div>
    				</form>
    			</div>
    		</div>
