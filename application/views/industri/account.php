...
<form class="form-horizontal" action="<?php echo current_url(); ?>" method="post">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-8">
    <input type="text" name="name" class="form-control" value="<?php echo $user->name ?>" placeholder="">
...
<div class="form-group">
 ...
 <div class="col-sm-4">
  <input type="number" name="karyawan" class="form-control" value="<?php echo $user->karyawan ?>" placeholder="">

  <p class="help-block"><?php  echo form_error('email', '<small class="text-red">', '</small>'); ?></p>
</div>
<div class="col-sm-2">Orang</div>
</div>
