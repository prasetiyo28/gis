    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <div class="input-group">
                <input id="input-calendar" type="text" name="mulai" class="form-control" placeholder="mulai dar Rp...">
        ...
        <div class="col-sm-4">
            <div class="input-group">
                <input id="input-calendar" type="text" name="sampai" class="form-control" placeholder="sampai Rp...">
                <span class="input-group-addon"><i class="fa fa-money"></i></span>
            </div>
