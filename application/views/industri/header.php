	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url() ?>">Industri User</a>
			</div>
			...
			<div class="col-md-2 user-sidebar">
				<div id="sidebar-sticker">
					<div class="list-group" style="margin-top: 20px;">
						<a href="<?php echo base_url('Industri') ?>" class="list-group-item <?php echo active_link_method('index', 'Industri') ?>">
							<i class="fa fa-home"></i> Home
						</a>
						<a href="<?php echo base_url('Industri/addproduk') ?>" class="list-group-item <?php echo active_link_method('addproduk', 'Industri') ?>">
							<i class="fa fa-plus"></i> Tambah Produk
						</a>
						<a href="<?php echo base_url('Industri/produk') ?>" class="list-group-item <?php echo active_link_method('produk', 'Industri') ?>">
							<i class="fa fa-industry"></i> Data Produk
						</a>
						<a href="<?php echo base_url('Industri/account') ?>" class="list-group-item <?php echo active_link_method('account', 'Industri') ?>">
