...
<form class="form-horizontal" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" name="title" class="form-control" value="<?php echo $artikel->title ?>" placeholder="">
  ...
  <div class="form-group">
   ...
   <div class="col-md-4">
    <?php if($artikel->photo != '') : ?>
      <img src="<?php echo base_url("public/image/{$artikel->photo}") ?>" height="150">
    <?php endif; ?>
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-sm-8">
    <textarea name="content" class="form-control" rows="8"><?php echo $artikel->content ?></textarea>
